...
# from diabetes_risk_prediction.entity.config_entity import DataIngestionConfig, DataValidationConfig
...
# print(artifact)
# print(f"Train file path: {artifact.train_file_path}")
...
#     drift_report_dir="artifacts/data_validation/drift_report"
# )
